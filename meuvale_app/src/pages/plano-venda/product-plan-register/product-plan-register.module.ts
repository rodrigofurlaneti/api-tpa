...
import { ProductPlanRegisterPage } from './product-plan-register';
import { BrMaskerModule } from 'brmasker-ionic-3';
import { FirebaseUploadModule } from '../../../components/firebase-upload/firebase-upload.module';

@NgModule({
  declarations: [
    ProductPlanRegisterPage,
  ],
  imports: [
    BrMaskerModule,
    IonicPageModule.forChild(ProductPlanRegisterPage),
...
export class ProductPlanRegisterPageModule {}
